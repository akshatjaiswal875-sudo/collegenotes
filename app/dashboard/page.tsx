            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="relative mb-8">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none shadow-sm text-gray-900"
                  value={search}
